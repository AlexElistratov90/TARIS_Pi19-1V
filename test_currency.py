...
class TestCurrency(unittest.TestCase):
    ...
    def test_currency_positive(self):
        ...
        self.assertEqual(res, 1115.2838960000001)
...
@pytest.mark.parametrize("num, output",
                         [(0.0275192, 2651.92), (0.039605, 3860.5), (6.39742056, 639642.056), (0.0275192, 1)])
...
@pytest.mark.parametrize("rate, output", [('AUD', 0.0212775), ('GBP', 0.0131962), ('AMD', 6.39742056), ('BYN', 0)])
...
# output - стоимость в руб с учетом комиссии
@pytest.mark.parametrize("rate, value, output", [('AUD', 0.0212775, 2276.0190000000002),
                                                 ('GBP', 0.0131962, 1166.6129999999998),
